           ...
           % DATA IMPORT
                hd.ToolBar.MainMenu.import = uimenu(hd.ToolBar.MainMenu.navDIC,...
                    ...
                    hd.ToolBar.MainMenu.importFrames = uimenu(hd.ToolBar.MainMenu.import,...
                                                            'Label','Frames', ...
                                                            'Enable','on') ;
                        hd.ToolBar.MainMenu.importBinaryImagesFolder = uimenu(hd.ToolBar.MainMenu.importFrames,...
<<<<<<< HEAD
                                                                'Label','Binary Images', ...
=======
                                                                'Label','Binary Image Folder', ...
>>>>>>> PierreBranch
                                                                'Enable','on', ...
                                                                'callback',@(src,evt)import('BinaryImageFolder')) ;
        ...
        % REAL-TIME ACQUISITION ----------------------------------------------------------
           ...
           % SAVING
                hd.ToolBar.MainMenu.saving = uimenu(hd.ToolBar.MainMenu.realTime,...
                    ...
                    hd.ToolBar.MainMenu.saveImagesBin = uimenu(hd.ToolBar.MainMenu.saving,...
                                                            'Label','Images binary files', ...
                                                            'Enable','on', ...
                                                            'Checked','off', ...
                                                            'callback',@(src,evt)setSaving(src)) ;
        ...
        % If cameras are here but no Images, offer to load them
            for camID = 1:length(hd.Cameras)
                if ~isfield(newHD,'Images') ... No images where available at all
                    ...
                    answer = questdlg(msg,'Image Source','Binary Image Folder','Image Folder','Video','Skip','Skip') ;
                    switch answer
                        case 'Binary Image Folder'
                            [~,hd] = loadFrames(hd,'BinaryImageFolder',camID) ;
                        case 'Image Folder'
