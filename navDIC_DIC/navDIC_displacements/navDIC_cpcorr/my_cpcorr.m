function xymoving = my_cpcorr(varargin)
...
% initialize ctrl pts as non valid
    xymoving = xymoving_in*NaN;
...
% eliminate control points moved outside of the domain
    outside = any(xymoving>ones(ncp,1)*flip(size(moving))+0.5,2) | any(xymoving<0.5,2) ;
    xymoving(outside,:) = NaN ;
