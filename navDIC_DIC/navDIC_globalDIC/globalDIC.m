...
% PARAMETERS
    ...
    % Reference Image 
        weightCurrentImage = 0.005 ; %0.025 ; % After convergence, add the current image to the reference image ([0->1])
    ...
    % Convergence Criteria
        ...
        minNorm = 1e-5 ; % Maximum displacement of a node
    ...
    % Displacement Processing
        ...
        strainOnNodes = true ;
    % Plotting
        plotRate = 2 ; % Plot Refresh Frequency 
