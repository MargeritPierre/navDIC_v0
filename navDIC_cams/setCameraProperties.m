...
ang = input('Entrer la valeur de l''angle du plan horizontale de la camera 0 : Cam 1 90 : Cam 2 (°) : ') ;
ang = input('Entrer la valeur de l''angle autour de l''axe optique de la camera 0 (°) : ') ;
